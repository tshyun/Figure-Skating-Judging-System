...
// Represents a writer that writes JSON representation of ListOfJudgeScores to file
public class JsonWriterListOfJudgeScores {
    private static final int TAB = 4;
    private PrintWriter writer;
    private String destination;

    public JsonWriterListOfJudgeScores(String destination) {
